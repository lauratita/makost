 ...
 * @author dF
 */
public class Pembayaran1 extends javax.swing.JPanel {
    ...
    private void totalBiaya() {
        ...
        for (int i = 0; i < jumlahBaris; i++) {
            ...
            totalBiaya = totalBiaya + (jumlahTarif * hargaTarif);
        }
        txtTotalHarga.setText(String.valueOf(totalBiaya));
    }
    ...
    private void initComponents() {
        ...
        gradientRPanel1.setColor1(new java.awt.Color(0, 153, 153));
    ...
    private void txtJumlahTarifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtJumlahTarifActionPerformed
        ...
        harga = Integer.parseInt(txtHargaTarif.getText());
        jumlah = Integer.parseInt(txtJumlahTarif.getText());
        total = harga * jumlah;
        ...
        if (total > bayar) {
            ...
            try {
                ...
                for (int i = 0; i < baris; i++) {
                    String sql = "INSERT INTO tbl_detailpembayaran (no_transaksi, id_tarif, nama_tarif, jumlah, harga, total)"
                            + " VALUES('"
    ...
    private apk.makost.swing.Combobox cbTipeKamar;
    ...
    private apk.makost.swing.Spinner spinnerStatus;
    ...
    private apk.makost.swing.TextField txtJumlahTarif;
